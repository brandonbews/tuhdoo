...
## v1 — Steering, and a second machine *(milestone task closed 2026-08-12 — closure note below)*
...
*(Closure note, 2026-08-12: Brandon closed the milestone task (`t-…qm7a`) as a road-sign retirement, explicitly **not** a formal phase declaration — his framing: he no longer needs a v1 road sign; the ledger steers directly now. Evidence state at closure: clause 2 proven by the collision harness (2026-08-03, extended 2026-08-05 to the real D6 machinery and the confirmation-race storm); clause 3 judged met by the same adoption surface that closed the launch epic the same day; clause 1 never formally round-tripped end-to-end. No phase beyond v1 is scheduled — post-launch, work is planned on the ledger, not in phases. Epoch compaction (D9), formerly gated on this milestone, was parked `held` the same day and unparks on real repo-size pressure, not on this label.)*
