...
0 in progress · 4 ready · 3 blocked · 7 on hold · 6 inbox · 116 done · 30 cancelled
...
|---|---|---:|---|
| [`tuh-6hd8`](tasks/tuh-01M26H99G1YXYDCSBFNQEF6HD8.md) | Read fast, start fast: batch blob reads, Go-side object IDs, bind-before-load | 1 | depends on [`tuh-1bap`](tasks/tuh-01M26H99BZBCHHZX7G98X41BAP.md) |
| [`tuh-k0zx`](tasks/tuh-01M26H99M5ZYK5NSGDKQT3K0ZX.md) | The store as live replica: in-memory head and tree, single ref mover, persistent index, write only what changed | 1 | depends on [`tuh-6hd8`](tasks/tuh-01M26H99G1YXYDCSBFNQEF6HD8.md) |
...
- [`tuh-g9dt`](tasks/tuh-01KZ4PY7QJEAZ6T8R1V046G9DT.md) Task history: render task.updated field edits — every edit, compact old→new lines
...
- [`tuh-n0er`](tasks/tuh-01KZEPBEE8HFDQVK96AV6RN0ER.md) Launch tuhdoo: public-facing materials and adoption surface
