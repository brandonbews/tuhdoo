...
1 in progress · 1 ready · 2 blocked · 5 on hold · 18 inbox · 62 done · 12 cancelled

## In progress

| ID | Task | Priority | Claimed by |
|---|---|---:|---|
| [`tuh-y4re`](tasks/tuh-01KZ9Y3THHH5B8GT22T7JVY4RE.md) | init hardening: loud unknown-flag errors and the MCP snippet in init output | 2 | `brandon/claude-code-1` |
...
| [`tuh-r40k`](tasks/tuh-01KZ9Y3THHH5B8GT22T910R40K.md) | Cut v0.2.0: final verification and tag handoff | 0 | depends on [`tuh-y4re`](tasks/tuh-01KZ9Y3THHH5B8GT22T7JVY4RE.md); depends on [`tuh-7a40`](tasks/tuh-01KZ4TH4HT56TE4CQPKKA37A40.md) |
