...
1 in progress · 5 ready · 0 blocked · 7 on hold · 7 inbox · 110 done · 30 cancelled

## In progress

| ID | Task | Priority | Claimed by |
|---|---|---:|---|
| [`tuh-kkdt`](tasks/tuh-01KZVZT7F8CVJYX1NZZWMSKKDT.md) | Pin replay edges: holder's late finish counts as done; reconcile the subject-less-event stance | — | `brandon/claude-code-2` |
