...
1 in progress · 3 ready · 0 blocked · 7 on hold · 7 inbox · 112 done · 30 cancelled

## In progress

| ID | Task | Priority | Claimed by |
|---|---|---:|---|
| [`tuh-j4d9`](tasks/tuh-01KZVZT7F8CVJYX1P009AJJ4D9.md) | 002 doc-drift sweep: T6 view-stamp path; T7 WAITING vocabulary, parent remnants, shelf bolding | — | `brandon/claude-code-2` |
