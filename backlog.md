...
1 in progress · 1 ready · 1 blocked · 8 on hold · 7 inbox · 68 done · 18 cancelled

## In progress

| ID | Task | Priority | Claimed by |
|---|---|---:|---|
| [`tuh-ek1s`](tasks/tuh-01KZA0VT234XJYVZWT93P2EK1S.md) | Uninstall doc + test: prove a team can walk away clean | 0 | `brandon/claude-code-1` |
