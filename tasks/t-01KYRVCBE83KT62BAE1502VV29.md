# npm devDependency distribution (esbuild-pattern wrapper packages)

`t-01KYRVCBE83KT62BAE1502VV29`

- **Status:** done
- **Priority:** 1
- **Labels:** `distribution` `npm`
- **Depends on:** [`t-tam8`](t-01KYRVCBE83KT62BAE11W3TAM8.md) (done)
...
### 2026-07-31 06:04 UTC — edit by `brandon`
