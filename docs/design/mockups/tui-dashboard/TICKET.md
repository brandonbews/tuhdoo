# Ticket draft: TUI dashboard visual redesign (mock-a)

Paste the body below into `create_task`. Suggested: priority 1, labels
`cli, tui, design`.

---

**Title:** TUI dashboard visual redesign: section bars + fixed column grid (mock-a)
